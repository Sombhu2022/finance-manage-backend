...
jest.unstable_mockModule('../src/shared/utils/db-migrate.js', () => ({
  runMigrations: jest.fn(),
}));

// Use dynamic imports after the mock module call
const { runMigrations } = await import('../src/shared/utils/db-migrate.js');
const { default: createApp } = await import('../src/core/app.js');
